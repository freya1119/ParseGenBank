...
# 
# ID=aggregate(ID_table, by=list(ID_table$taxon_id), max)
# ID=aggregate(ID_table, by=list(ID_table$taxon_id), toString)
# ID=aggregate(ID_table, by=list(ID_table$taxon_id), paste)
# ID=aggregate(ID_table, by=list(ID_table$taxon_id), list)
ID=aggregate(ID_table, by=list(ID_table$taxon_id), unique)
#ID=aggregate(ID_table, by=list(ID_table$taxon_id), str_c)

# 
# Species_by_ID=aggregate(ID_table[,c(1,2)], by=list(ID_table$taxon_id), max)
# Genes_by_ID=aggregate(ID_table[,c(2:ncol(ID_table))], by=list(ID_table$taxon_id), unique)
