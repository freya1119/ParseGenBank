...
```{r, eval=FALSE, tidy=TRUE}
test=c(
"Afrignathia","Bathygnathia","Bythognathia","Caecognathia","Elaphognathia","Euneognathia","Gibbagnathia","Gnathia","Monodgnathia","Paragnathia","Tenerognathia","Thaumastognathia"
)
count=0
for(i in test){
  if(i %in% genera){
