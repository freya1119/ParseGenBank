...
#gene from genbank
#I was pulling gene name from fasta description but other elements of description were being flagged as gene names (ex. H3)
ingenes=FALSE
gen=""
gene_pattern="gene=\"([^\"]+)\""
gen=str_replace(str_extract(gb,gene_pattern),gene_pattern,"\\1")
#in case gene is not explicitly listed, check product:
if(is.na(gen)){
product_pattern="product=\"([^\"]+)\""
gen=str_replace(str_extract(gb,pro_pattern),pro_pattern,"\\1")
}
