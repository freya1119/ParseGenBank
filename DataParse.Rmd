...
genelookup= data.frame(
  ...
  genelist=c("COI","COI","H3","12S","16S","16S","18S","18S","28S","RpS5","RpS2","ArgKin","EF1a","EF1a","GAPDH","IDH","MDH","CAD","Wgl","COX2","COX3","COX3","ATP6","CytB","HSP70","mt Genome","mt Genome","partial mt Genome","ITS2","ITS1","transposon","Unknown","anonymous locus","NAK-ATPase","NAK-ATPase","PTGS","PTGS","GH7D","GH7A","MnSOD","hemocyanin","ND5","CsDll","RNAseq contig","microsat")
)
