...
genelookup= data.frame(
  rawlist=c("cytochrome [c ]{0,2}oxidase [subunit ]{0,8}[I1] ","[cC][Oo][Xx]{0,1}[1Ii][ )]","histone H{0,1}3","12S","16S","18S","small subunit ribosomal","28S","RpS5","RpS2","ArgKin","EF1-{0,1}a","GAPDH","IDH","MDH","CAD","wingless","COX2","COX3","ATP6","cytochrome b","HSP70","mitochondrion, complete genome","internal transcribed spacer 2","transposon","Unknown sequence"),
  genelist=c("COI","COI","H3","12S","16S","18S","18S","28S","RpS5","RpS2","ArgKin","EF1a","GAPDH","IDH","MDH","CAD","Wgl","COX2","COX3","ATP6","CytB","HSP70","Mito Genome","ITS2","transposon","Unknown")
)
...
df=data.frame(species_name,organism,taxon_id,voucher,isolate,country,accession,gene,bp_length,author_ref1,title_ref1,journal_ref1,author_ref2,title_ref2,journal_ref2,author_ref3,title_ref3,journal_ref3,description,fasta_header,sequence)
...
gene_table=data.frame(matrix(NA, nrow=0, ncol=28))
